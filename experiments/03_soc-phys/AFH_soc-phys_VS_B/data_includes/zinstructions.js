...
newTrial("instructions1_sp",
    ...
    newText("<br>")
        ...
        .print() 
    ,
    newText("In the second part of the experiment, your job is to categorize each word as <b>SOCIAL</b> or <b>PHYSICAL</b>. You can answer by pressing the corresponding <b>F</b> or the <b>J</b> key on your keyboard.")
        .center()
        .print()
    ,
    newText("<br>")
        ...
        .print() 
    ,
    newText("For example, most people would agree that the word <b>ROUND</b> generally has PHYSICAL associations. Physical words refer to things perceived through the senses as opposed to the mind. You should indicate a word is physical in this sense by pressing the key corresponding to <b>PHYSICAL</b>.")
        .center()
        .print()
    ,
    newText("<br>")
        ...
        .print()
    ,
    newText("In contrast, most people would agree that the word <b>RUDE</b> generally has SOCIAL associations. SOCIAL words refer to society or its organization. You should indicate a word is social in this sense by pressing the key corresponding to <b>SOCIAL</b>.")
        .center()
        .print()
    ,
    newText("<br>")
...
newTrial("instructions2_sp",
    ...
    newText("<br>")
        ...
        .print() 
    ,
    newText("Some words may not be straightforwardly one or the other. If you feel a word is neither social nor physical, try your best to choose one option all the same.")
        .center()
        .print()
    ,
    newText("<br>")
