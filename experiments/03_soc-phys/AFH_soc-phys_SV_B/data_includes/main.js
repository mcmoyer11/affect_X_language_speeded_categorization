...
Sequence(
    ...
    "consent",
        ...
        rshuffle("calibrator_sp_feedback"),
        // One round without
        rshuffle("calibrator_sp_no_feedback"),
...
PennController("end",
    newText("Thank you for your participation!<br><br>")
        ...
        .print()
        ,
    newText("link",'<a href="https://app.prolific.com/submissions/complete?cc=C1KMCHFH">Click here if you do not automatically redirect.</a><br><br>')
        .center()
        .print()
    ,
    newText("Or, enter this completion code: C1KMCHFH")
        .center()
        .print()
    ,
    newKey("end", " ")
