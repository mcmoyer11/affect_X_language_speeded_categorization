...
newTrial("instructions1_sp",
    ...
    newText("<br>")
        ...
        .print() 
    ,
    newText("In the first part of the experiment, your job is to categorize each word as <b>SOCIAL</b> or <b>PHYSICAL</b>. You can answer by pressing the corresponding <b>F</b> or the <b>J</b> key on your keyboard.")
        .center()
        .print()
    ,
    newText("<br>")
