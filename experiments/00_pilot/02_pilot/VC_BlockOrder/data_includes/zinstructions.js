...
newTrial("instructions2_val",
    ...
    newText("For example, the word <b>KITTEN</b> generally has POSITIVE associations. That means thinking of kittens make you feel happy, pleased, satisfied, contented, hopeful. You can indicate a word is positive in this sense by pressing the key corresponding to <b>POSITIVE</b>.")
        .center()
        .print()
    ,
    newText("<br>")
        ...
        .print()
    ,
    newText("In contrast, the word <b>DEATH</b> generally has NEGATIVE associations. That means thinking of death make you feel completely unhappy, annoyed, unsatisfied, melancholic, despaired, or bored. You can indicate a word is negative in this sense by pressing the key corresponding to <b>NEGATIVE</b>.")
        .center()
        .print()
    ,
    newText("<br>")
...
newTrial("mid_task_instructions",
    newText("Great Job completing the first half of the experiment!")
        .center()
        .print()
    ,
    newText("Now begins the second portion of the experiment.")
        .center()
        .print()
    ,
    newText("<br>")
...
newTrial("instructions1_conc",
    newText("In the second part of the experiment, your job is to categorize each word as <b>ABSTRACT</b> or <b>CONCRETE</b>. You can answer by pressing the corresponding <b>F</b> or the <b>J</b> key on your keyboard.")
        .center()
        .print()
    ,
    newText("<br>")
...
newTrial("instructions2_conc",
    ...
    newText("For example, the word <b>KITTEN</b> generally has CONCRETE associations. Concrete words refer to things or actions in reality, which you can experience directly through one of the five senses. You should indicate a word is concrete in this sense by pressing the key corresponding to <b>CONCRETE</b>.")
        .center()
        .print()
    ,
    newText("<br>")
        ...
        .print()
    ,
    newText("In contrast, the word <b>LIBERTY</b> generally has ABSTRACT associations. Abstract words refer to things that cannot be experienced directly through your senses or actions, but which we know because their meanings can be defined by other words. You should indicate a word is abstract in this sense by pressing the key corresponding to <b>ABSTRACT</b>.")
        .center()
        .print()
    ,
    newText("<br>")
