...
newTrial("instructions1_ani",
    ...
    newText("<br>")
        ...
        .print() 
    ,
    newText("In the first part of the experiment, your job is to categorize each word as <b>ANIMATE</b> or <b>INANIMATE</b>. You can answer by pressing the corresponding <b>F</b> or the <b>J</b> key on your keyboard. Make sure to double-check which key corresponds to which answer when the experiment begins.")
        .center()
        .print()
    ,
    newText("<br>")
...
newTrial("instructions1_val",
    ...
    newText("<br>")
        ...
        .print() 
    ,
    newText("In the second part of the experiment, your job is to categorize each word as <b>POSITIVE</b> or <b>NEGATIVE</b>. You can answer by pressing the corresponding <b>F</b> or the <b>J</b> key on your keyboard. Make sure to double-check which key corresponds to which answer when the experiment begins.")
        .center()
        .print()
    ,
    newText("<br>")
