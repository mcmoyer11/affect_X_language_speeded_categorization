...
newTrial("instructions1_phys",
    ...
    newText("<br>")
        ...
        .print() 
    ,
    newText("In the second part of the experiment, your job is to categorize each word as <b>PHYSICAL</b> or <b>PSYCHOLOGICAL</b>. You can answer by pressing the corresponding <b>F</b> or the <b>J</b> key on your keyboard.")
        .center()
        .print()
    ,
    newText("<br>")
        ...
        .print() 
    ,
    newText("For example, most people would agree that the word <b>KITTEN</b> generally has PHYSICAL associations. Physical words relate to the body, material objects, or the natural world. You should indicate a word is physical in this sense by pressing the key corresponding to <b>PHYSICAL</b>.")
        .center()
        .print()
    ,
    newText("<br>")
        ...
        .print()
    ,
    newText("In contrast, most people would agree that the word <b>LIBERTY</b> generally has PSYCHOLOGICAL associations. Psychological words relate to mental processes, emotions, or behavior as experienced or understood by the mind. You should indicate a word is psychological in this sense by pressing the key corresponding to <b>PSYCHOLOGICAL</b>.")
        .center()
        .print()
    ,
    newText("<br>")
