...
newTrial("instructions1_so",
    ...
    newText("<br>")
        ...
        .print() 
    ,
    newText("In the second part of the experiment, your job is to categorize each word as <b>SUBJECTIVE</b> or <b>OBJECTIVE</b>. You can answer by pressing the corresponding <b>F</b> or the <b>J</b> key on your keyboard.")
        .center()
        .print()
    ,
    newText("<br>")
