...
# Read in the results
vc.a <- read.pcibex("../data/AFH_syn-val_SV_A.csv")
vc.a["BlockOrder"] <- "SV"
# vc.a["Group"] <- "A"
length(unique(vc.a$MD5.hash.of.participant.s.IP.address))

vc.b <- read.pcibex("../data/AFH_syn-val_SV_B.csv")
vc.b["BlockOrder"] <- "SV"
# vc.b["Group"] <- "B"
length(unique(vc.b$MD5.hash.of.participant.s.IP.address))

cv.a <- read.pcibex("../data/AFH_syn-val_VS_A.csv")
cv.a["BlockOrder"] <- "VS"
# cv.a["Group"] <- "A"
length(unique(cv.a$MD5.hash.of.participant.s.IP.address))

cv.b <- read.pcibex("../data/AFH_syn-val_VS_B.csv")
cv.b["BlockOrder"] <- "VS"
# cv.b["Group"] <- "B"
