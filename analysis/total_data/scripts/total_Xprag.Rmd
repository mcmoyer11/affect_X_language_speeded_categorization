...
sub <- d[,c("Word","ID.true","Experiment","Task","LogReactionTime","Response","Accuracy","ConcValCombo")]
sub$ExperimentType <- "Categorization"
write.csv(sub,"../data/categorization.csv")
```
