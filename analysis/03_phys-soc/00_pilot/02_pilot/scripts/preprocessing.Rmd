...
# Read in the results
vc.a <- read.pcibex("../data/adjs3_soc-phys_VS_A.csv")
vc.a["BlockOrder"] <- "VS"
length(unique(vc.a$MD5.hash.of.participant.s.IP.address))

vc.b <- read.pcibex("../data/adjs3_soc-phys_VS_B.csv")
vc.b["BlockOrder"] <- "VS"
length(unique(vc.b$MD5.hash.of.participant.s.IP.address))

cv.a <- read.pcibex("../data/adjs3_soc-phys_SV_A.csv")
cv.a["BlockOrder"] <- "SV"
length(unique(cv.a$MD5.hash.of.participant.s.IP.address))

cv.b <- read.pcibex("../data/adjs3_soc-phys_SV_B.csv")
cv.b["BlockOrder"] <- "SV"
