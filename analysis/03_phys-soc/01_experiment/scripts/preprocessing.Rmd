---
title: 'Adjs Soc-Phys: preprocessing'
author: "author"
date: "`r Sys.Date()`"
...
d$ConcValCombo <- as.character(paste(d$SocPhys,d$Valence))
names(d)
