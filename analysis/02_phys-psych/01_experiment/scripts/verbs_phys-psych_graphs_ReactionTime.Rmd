---
title: "Verbs Phys-Psych: Reaction Time Graphs"
author: "morgan moyer"
date: "`r Sys.Date()`"
output: pdf_document
---
...
ggsave("../graphs/exp2a_abs.pdf",width = 3, height = 2)
ggsave("../graphs/exp2a_pres.pdf",width = 5, height = 4)
```
...
ggsave("../graphs/exp2a_paper.jpg",width = 6, height = 3)
...
ggsave("../graphs/exp2a_items.pdf",width = 8, height = 6)
```
...
### Mean Raw ReactionTime and Effects of Word Valence/PhysPsychness
